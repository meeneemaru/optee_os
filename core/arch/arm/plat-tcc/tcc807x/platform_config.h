...
/* GIC */
#define GICD_BASE		U(0x17600000)
#define GICC_BASE		U(0x17680000)
...
#define TZC_OMC_BASE		(TZC_BASE + U(0xC0000))
#define TZC_OMC_FILTERS		U(4)
#define TZC_OMC_FILTER_OFFS	U(0x10000)
#define TZC_OMC_INT_0		(395 + 32)
#define TZC_OMC_INT_1		(407 + 32)
#define TZC_OMC_INT_2		(419 + 32)
#define TZC_OMC_INT_3		(431 + 32)
#define TZC_TEEOS_REGION_NUM    U(1)

/* MailBox with HSM */
#define MBOX_HSM_BASE		U(0x1E150000)
